...
{
    partial class OrderFormCustomer
    {
        /// <summary>
        ...
        {
            System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(OrderFormCustomer));
            button1 = new Button();
            panel1 = new Panel();
            label2 = new Label();
            panel2 = new Panel();
            ...
            // listView1
            // 
            listView1.Columns.AddRange(new ColumnHeader[] { Order, Quantity, Subtotal });
            listView1.Location = new Point(236, 105);
